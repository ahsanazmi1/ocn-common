    ...
    def get_schema(self, schema_name: str, schema_type: str = "mandates") -> Dict[str, Any]:
        ...
        if cache_key not in self._schemas_cache:
            if schema_type == "mandates":
                ...
                schema_path = self.base_path / "common" / "events" / "v1" / f"{schema_name}.schema.json"
            else:
...
class ContractValidator:
    ...
    def _get_validator(self, schema_name: str, schema_type: str = "mandates") -> Draft202012Validator:
    ...
    def validate_json(self, payload: Union[Dict[str, Any], str], schema_name: str) -> bool:
        ...
        try:
            ...
            raise ContractValidationError(f"Validation failed for schema '{schema_name}': {e.message}")
    ...
    def validate_cloudevent(self, payload: Union[Dict[str, Any], str], type_name: str) -> bool:
        ...
        try:
            ...
            raise ContractValidationError(f"Validation failed for CloudEvent type '{type_name}': {e.message}")
        except Exception as e:
            raise ContractValidationError(f"Unexpected validation error: {e}")
    
    def get_validation_errors(self, payload: Union[Dict[str, Any], str], schema_name: str, schema_type: str = "mandates") -> list:
        """
