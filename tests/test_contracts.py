        ...
        decision_ce = {
            ...
            "data": {
                ...
                "cart": {
                    "amount": "99.99",
                    "currency": "USD",
                    "items": [{"id": "item_001", "name": "Test", "amount": "99.99", "quantity": 1, "category": "Test"}],
                    "geo": {"country": "US"},
                    "metadata": {}
                },
                "payment": {
...
class TestConvenienceFunctions:
    ...
    def test_validate_cloudevent_function(self):
        ...
        decision_ce = {
            ...
            "data": {
                "ap2_version": "0.1.0",
                "intent": {"actor": {"id": "user_123", "type": "user"}, "channel": "web", "geo": {"country": "US"}, "metadata": {}},
                "cart": {"amount": "99.99", "currency": "USD", "items": [{"id": "item_001", "name": "Test", "amount": "99.99", "quantity": 1, "category": "Test"}], "geo": {"country": "US"}, "metadata": {}},
                "payment": {"method": "card", "modality": {"type": "immediate", "description": "Test"}, "auth_requirements": ["pin"], "metadata": {}},
                "decision": {"result": "APPROVE", "risk_score": 0.15, "reasons": ["Test"], "actions": ["Test"], "meta": {}},
